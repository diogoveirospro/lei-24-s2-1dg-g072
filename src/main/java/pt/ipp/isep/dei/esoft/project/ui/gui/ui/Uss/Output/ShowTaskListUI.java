...
public class ShowTaskListUI implements Initializable {
    ...
    public void showUI(Stage stage, List<String> taskList, String[][] dates) throws Exception {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/USs/Output/ShowListTask.fxml"));
        Parent root = loader.load();
        Scene scene = new Scene(root);
        stage.setTitle(LIST);
        stage.setScene(scene);
        showListTaskController.setDates(dates);
        showListTaskController.setTaskList(taskList);
