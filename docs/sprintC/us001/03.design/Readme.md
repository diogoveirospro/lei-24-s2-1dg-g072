...
| Step 3         |                                             |                         |                                                                                                                                                            |
| Step 4         |                                             |                         |                                                                                                                                                            |
| Step 5         | ... coordinating the US?                    | RegisterSkillController | Controller: coordinates the interactions related to registering skills in the user interface (UI) and executes the logic needed to process these requests. |
|                | ... instantiating a new Skill?              | SkillRepository         | Creator (Rule 2): the SkillRepository registers a Skill instance.                                                                                          |
|                | ... saving the inputted data?               | Skill                   | IE: object created in step 1 has its own data.                                                                                                             |
