# US005 - Automatically generate a team proposal
...
_The GRH wants to automatically generate a team proposal._
...
* **AC1:** The pretended number of collaborators must be given by the GRH.
* **AC2:** The desired skill set must be provided by the GRH.
