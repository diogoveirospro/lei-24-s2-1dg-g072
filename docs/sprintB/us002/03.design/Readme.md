...
|                | ... instantiating a new Job?                | Organization          | Creator (Rule 2): the Organisation registers a Job instance.                                                                                             |
...
|                | ... validate all data (global validation)?  | Organization          | IE: knows all its jobs.                                                                                                                                  |
